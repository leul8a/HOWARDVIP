...
# Ensure that you have the stopwords downloaded
...
for _ in range(1):  # Replace with `while True:` for continuous execution
    # Get the url content
    r = requests.get("http://localhost:8000/sample_website.html")  # Update with your URL
